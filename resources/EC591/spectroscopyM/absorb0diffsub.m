function absorb0diffsub(filename)
%z is the wavelength vector
...
for a = 1:length(v1a)
    v1c(a) = (-1/v1a(a))*log(abs(v1b(a))/abs(v2b(a)));
end
...
filename(txtdel:end) = [];
savename = strcat(filename, '-absorb.txt');
